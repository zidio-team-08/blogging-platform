...
import { FiImage, FiPlus, FiX, FiUpload } from 'react-icons/fi'
...
const BlogPreview = ({ content, title, onBack, onPublish }) => {
    ...
    return (
        <div className='w-full max-w-6xl mx-auto min-sm:px-4'>
            <h2 className='p-4 text-lg font-semibold font1'>Story Preview</h2>
            <div className="flex flex-col md:flex-row gap-6 w-full">
                ...
                <div className="w-full md:w-2/3 flex flex-col font1">
