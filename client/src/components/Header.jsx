            ...
            <div className="w-full h-14 bg-base-100 border border-base-300 flex items-center justify-between px-6 relative max-[810px]:px-4">
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <div className="dropdown dropdown-end">
                        ...
                        <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-1 w-52  shadow-md border border-base-300">
                            <li><Link className='text-[16px] font-medium py rounded-md hover:bg-base-200' to='/new-story'><AiFillEdit />Write</Link></li>
                            <li><Link className='text-[16px] font-medium py rounded-md hover:bg-base-200' to='/profile'><FiUser />Profile</Link></li>
                            <li><Link className='text-[16px] font-medium py rounded-md hover:bg-base-200 text-red-600' to='/settings'><AiOutlineSetting />Logout</Link></li>
                        </ul>
                    </div>
                </div>
            </div>
