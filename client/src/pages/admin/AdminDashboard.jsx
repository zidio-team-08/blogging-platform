...
import { FiUsers, FiFileText, FiUserCheck, FiUserX } from 'react-icons/fi'
            ...
            <div className="flex flex-col md:flex-row">
                ...
                <div className="flex-1 xl:ml-64 p-3 sm:p-4 md:p-6 overflow-auto">
                    <div className="mb-4 sm:mb-6">
                        <h1 className="text-xl sm:text-xl uppercase font-bold text-base-content">Dashboard</h1>
                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            <div className="bg-base-100 rounded-lg shadow-md overflow-hidden">
                                        ...
                                        <tbody className="bg-base-100 divide-y divide-base-300">
                                            {recentUsers.map(user => (
                                                <tr key={user.id}>
                                                    ...
                                                    <td className="px-3 sm:px-6 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm font-medium">
                                                        <Link to={`/admin/users/${user.id}`} className="text-primary hover:text-primary-focus mr-3">View</Link>
                                                    </td>
                                                </tr>
                                            ))}
                                        </tbody>
                                ...
                                <div className="bg-base-200 px-3 sm:px-4 py-2 sm:py-3 border-t border-gray-200 text-right">
